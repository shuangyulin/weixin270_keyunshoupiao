...
public class SijiController {
	...
	public R login(String username, String password, String captcha, HttpServletRequest request) {
		SijiEntity user = sijiService.selectOne(new EntityWrapper<SijiEntity>().eq("zhanghao", username));
		if(user==null || !user.getMima().equals(password)) {
			return R.error("账号或密码不正确");
		}
		String token = tokenService.generateToken(user.getId(), username,"siji",  "司机" );
    ...
    public R register(@RequestBody SijiEntity siji){
    	...
    	SijiEntity user = sijiService.selectOne(new EntityWrapper<SijiEntity>().eq("zhanghao", siji.getZhanghao()));
		if(user!=null) {
    ...
    public R getCurrUser(HttpServletRequest request){
        ...
        SijiEntity user = sijiService.selectById(id);
     ...
     */
    @RequestMapping("/page")
    public R page(@RequestParam Map<String, Object> params,SijiEntity siji, HttpServletRequest request){
     ...
     */
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,SijiEntity siji, HttpServletRequest request){
        EntityWrapper<SijiEntity> ew = new EntityWrapper<SijiEntity>();
		PageUtils page = sijiService.queryPage(params, MPUtil.sort(MPUtil.between(MPUtil.likeOrEq(ew, siji), params), params));
        return R.ok().put("data", page);
    }
	...
	public R remindCount(@PathVariable("columnName") String columnName, HttpServletRequest request, 
		...
		Wrapper<SijiEntity> wrapper = new EntityWrapper<SijiEntity>();
		if(map.get("remindstart")!=null) {
		...
		int count = sijiService.selectCount(wrapper);
