          ...
          <el-form-item class="input" label="体温" prop="tiwen">
              <el-input v-model="ruleForm.tiwen" 
                placeholder="体温" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="进站时间" prop="jinzhanshijian">
          <el-input v-model="ruleForm.jinzhanshijian" 
              placeholder="进站时间" clearable  :readonly="ro.jinzhanshijian"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="进站时间" prop="jinzhanshijian">
              <el-input v-model="ruleForm.jinzhanshijian" 
...
export default {
  ...
  methods: {
    ...
    onSubmit() {
        ...
        if (valid) {
          this.$http({
            url: `chengkedengji/${!this.ruleForm.id ? "save" : "update"}`,
            method: "post",
            data: this.ruleForm
          }).then(({ data }) => {
            if (data && data.code === 0) {
              this.$message({
                ...
                onClose: () => {
                  ...
                  this.parent.chengkedengjiCrossAddOrUpdateFlag = false;
                  this.parent.search();
