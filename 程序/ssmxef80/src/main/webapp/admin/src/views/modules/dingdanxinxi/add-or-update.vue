      ...
      <el-row>
          ...
          <el-form-item class="input" label="客车车牌号" prop="kechechepaihao">
              <el-input v-model="ruleForm.kechechepaihao" 
                placeholder="客车车牌号" readonly></el-input>
                                    ...
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="出发日期" prop="chufariqi">
          <el-input v-model="ruleForm.chufariqi" 
              placeholder="出发日期" clearable  :readonly="ro.chufariqi"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="出发日期" prop="chufariqi">
              <el-input v-model="ruleForm.chufariqi" 
                placeholder="出发日期" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        ...
        <el-form-item class="input" v-if="type!='info'"  label="起点" prop="qidian">
          <el-input v-model="ruleForm.qidian" 
              placeholder="起点" clearable  :readonly="ro.qidian"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="起点" prop="qidian">
              <el-input v-model="ruleForm.qidian" 
                placeholder="起点" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="终点" prop="zhongdian">
          <el-input v-model="ruleForm.zhongdian" 
              placeholder="终点" clearable  :readonly="ro.zhongdian"></el-input>
        </el-form-item>
        <div v-else>
          <el-form-item class="input" label="终点" prop="zhongdian">
              <el-input v-model="ruleForm.zhongdian" 
                placeholder="终点" readonly></el-input>
          </el-form-item>
        </div>
      </el-col>
                                    <el-col :span="12">
        <el-form-item class="input" v-if="type!='info'"  label="座位类型" prop="zuoweileixing">
          <el-input v-model="ruleForm.zuoweileixing" 
              placeholder="座位类型" clearable  :readonly="ro.zuoweileixing"></el-input>
        </el-form-item>
        <div v-else>
          ...
          <el-form-item class="input" label="身份证" prop="shenfenzheng">
              <el-input v-model="ruleForm.shenfenzheng" 
                placeholder="身份证" readonly></el-input>
                                                                                                                                                                                                ...
                                                                                                                                                                                                <el-row>
            <el-col :span="24">
              <el-form-item class="textarea" v-if="type!='info'" label="购票内容" prop="goupiaoneirong">
                <el-input
                  style="min-width: 200px; max-width: 600px;"
                  type="textarea"
                  :rows="8"
                  placeholder="购票内容"
                  v-model="ruleForm.goupiaoneirong" >
                </el-input>
              </el-form-item>
              <div v-else>
                <el-form-item v-if="ruleForm.goupiaoneirong" label="购票内容" prop="goupiaoneirong">
                    <span>{{ruleForm.goupiaoneirong}}</span>
                </el-form-item>
              </div>
            </el-col>
          </el-row>
